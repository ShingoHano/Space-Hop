...
@interface RetinaMenuViewController ()

@end

@implementation RetinaMenuViewController

@synthesize sleder,sleder2;
@synthesize label1,label2,label3,label4,button1;


RetinaViewController *viewController;
...
- (void)viewDidLoad
{
    ...
    self.view.backgroundColor=[UIColor colorWithPatternImage:[UIImage imageNamed:@"bacl_wall5.png"]];
...
-(IBAction)gameStart:(id)sender
{
    ...
    viewController=[[RetinaViewController alloc]initWithNibName:@"RetinaViewController" bundle:nil];
